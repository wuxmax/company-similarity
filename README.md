...
More information could be leveraged from the descriptions by e.g. by extracting products or economic sectors from them. This could probably be done with a NER model, which has been trained on these kind of entities.
